...
/*    AnalogInput currentSensor = RobotMap.pickupCurrentSensor; */
 ...
 // removed Current Sensor to free up Analog Input port: using CAN input now
    ...
    public void setPickupMotorReverseDropoff() {
        double speed = 0.2;
